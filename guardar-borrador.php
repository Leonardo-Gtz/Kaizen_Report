...
try {
    ...
    // Validar campos obligatorios para borrador (solo tema y fecha)
    ...
    // Procesar archivo de riesgo (opcional en borrador)
    ...
    // Procesar imagen anterior (opcional en borrador)
    ...
    // Preparar statement para insertar borrador (con estado = 'borrador')
    $sqlRpt = "INSERT INTO reportes 
    (tema, fecha, imagen_anterior, descripcion_anterior, imagen_mejora, descripcion_mejora, analisis_riesgo, archivo_riesgo, estado, estadoRH, estadoSupervisor, estadoGerente, fecha_creacion) 
    ...
    $idCreador = isset($_SESSION['usuario']['id']) ? (int) $_SESSION['usuario']['id'] : null;
